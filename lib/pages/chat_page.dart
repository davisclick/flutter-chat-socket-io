...
class _ChatPageState extends State<ChatPage> {
  ...
  List<ChatMessage> _messages = [
    ...
    ChatMessage( uid: '1243', text: 'Hello World', ),
    ChatMessage( uid: '123', text: 'Hello World', ),
    ChatMessage( uid: '123', text: 'Hello Worlddddddddddddddddddddddddddddddddddd', ),
  ];
      ...
      appBar: AppBar(
        ...
        title: Column(
          children: [
            ...
            SizedBox( height:3 ),
             Text('Davis Alvarez', style: TextStyle( color: Colors.black87, fontSize: 12),)
          ],
        ),
        centerTitle: true,
        elevation: 1,
